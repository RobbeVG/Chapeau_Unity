...
namespace Seacore
{
    public class RoundManager : MonoBehaviour
    {
        ...
        [Header("Round States")]
        public RoundStates.Roll roll = new RoundStates.Roll();
        public RoundStates.Look look = new RoundStates.Look();
        public RoundStates.Declare declare = new RoundStates.Declare();
        public RoundStates.Action action = new RoundStates.Action();
        ...
        void Start()
        {
            ...
            if (DiceManager == null || GameManager == null)
